========================================================================
    KONSOLENANWENDUNG: DieselCoreTest-Projektübersicht
========================================================================

Diese DieselCoreTest-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre DieselCoreTest-Anwendung besteht.


DieselCoreTest.vcxproj
...
DieselCoreTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen DieselCoreTest.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
